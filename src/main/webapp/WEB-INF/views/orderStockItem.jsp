...
<head>
    ...
    <script type="text/javascript" src="/static/js/views/orderStockItem.js"></script>
</head>
<body>
<div class="easyui-layout" fit="true">
    <div data-options="region:'north',split:false,border:true" style="height:60px;">
        <form id="editForm">
            <div style="margin-top: 20px;margin-left: 10px">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="text" name="subbranchName" class="easyui-textbox"
                       data-options="label:'进货分店:',prompt:'输入要查找的店铺', width:200,labelWidth:60">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div data-options="region:'center',split:false,border:true" style="padding:5px;">
        <table id="orderStockItem_datagrid"></table>
    </div>
</div>
</body>
</html>
